...
df_game_sims %>% 
  ...
  select(game, total_line_current_label, total_mod_label, side_current_total, stake_current_total, spread_line_current_label, spread_mod_label, side_current_spread, stake_current_spread) %>%
  labelled::set_variable_labels(
    game = "Game",
    total_line_current_label = "Current Total Line",
    total_mod_label = "Predicted Total",
    side_current_total = "Total to Bet",
    stake_current_total = "Stake for Total",
    spread_line_current_label = "Current Spread Line",
    spread_mod_label = "Predicted Spread",
