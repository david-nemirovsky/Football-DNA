...
:::{.callout-note}
Updated as of Tuesday, January 27, 2026 at 7:21:32 PM 
:::
...
week_n = ifelse(ceiling(as.integer(Sys.Date() - as.Date("2025-09-07")) / 7) + 1 > 22, 22, ceiling(as.integer(Sys.Date() - as.Date("2025-09-07")) / 7))
...
mod_total_team_svm = readRDS(str_c("data/mods/", "mod_total_team_svm_2026_01_08.rds"))
mod_total_playoffs_team_svm = readRDS(str_c("data/mods/","mod_playoffs_total_team_svm_2026_01_04.rds"))
mod_total_correct_enet = readRDS(str_c("data/mods/", "mod_total_correct_enet.rds"))
mod_spread_correct_enet = readRDS(str_c("data/mods/", "mod_spread_correct_enet.rds"))
...
# set.seed(37564)
# boot_splits_total = bootstraps(df_playoffs_total_team_train, times = 200)
# 
...
#     tuneGrid = tibble(
#       sigma = mod_total_playoffs_team_svm$bestTune[[1]],
#       C = mod_total_playoffs_team_svm$bestTune[[2]]
#     )
#   )
# 
