...
df_total_team_test_solo_boot_prior %>% 
  ...
  mutate(
    ...
    points_text_label = round(mean_team_points_diff, 2)
      #str_c("(", round(team_points_mod, 1), "-", team_points_vegas, ")")
  ) %>% 
  ungroup() %>% 
  distinct(team, mean_team_points_diff, points_text_label_position, points_text_label, team_color, team_logo_espn) %>% 
