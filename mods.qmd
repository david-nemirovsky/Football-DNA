...
#     pred_lower = round(apply(pred_matrix_total, 1, quantile, probs = 0.025), 2),
#     pred_upper = round(apply(pred_matrix_total, 1, quantile, probs = 0.975), 2),
#   )
# 
...
#     pred_lower = round(apply(pred_matrix_total_prior, 1, quantile, probs = 0.025), 2),
#     pred_upper = round(apply(pred_matrix_total_prior, 1, quantile, probs = 0.975), 2),
#   )
# 
...
df_pred_total_spread_fin %>% 
  ...
  labs(
    x = "Predicted Total",
    y = NULL,
    title = glue::glue("Week {week_n} Spreads & Totals (95% Confidence Bands)")
  ) +
  theme_minimal() +
  theme(
