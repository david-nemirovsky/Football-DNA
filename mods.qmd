...
df_totals_hit_rate = 
  ...
  mutate(
    hit_rate_totals = str_c(n_hit, "/", n_total, " (", hit_rate, "%)")
  ) %>% 
  select(week, hit_rate_totals)
...
df_spreads_hit_rate =
  ...
  mutate(
    hit_rate_spreads = str_c(n_hit, "/", n_total, " (", hit_rate, "%)")
  ) %>% 
  select(week, hit_rate_spreads)

df_totals_hit_rate %>% 
  left_join(df_spreads_hit_rate, by = "week") %>% 
