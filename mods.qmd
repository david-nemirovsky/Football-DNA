...
df_schedule = 
  ...
  # rows_update(
  #   tibble(
  #     game_id = c("2025_19_LA_CAR", "2025_19_GB_CHI", "2025_19_BUF_JAX", "2025_19_SF_PHI", "2025_19_LAC_NE", "2025_19_HOU_PIT"),
  #     away_moneyline = c(-550, -112, -118, 180, 164, -175),
  #     home_moneyline = c(410, -108, -102, -218, -198, 145),
  #     spread_line = c(-9.5, -1.5, -1.5, 3.5, 3.5, -3.5),
  #     away_spread_odds = c(-112, -102, -102, -110, -105, -102),
  #     home_spread_odds = c(-108, -118, -118, -110, -115, -118),
  #     total_line = c(46.5, 46.5, 51.5, 45.5, 46.5, 39.5),
  #     under_odds = c(-110, -110, -108, -108, -110, -110),
  #     over_odds = c(-110, -110, -112, -112, -110, -110)
  #   )
  # ) %>% 
  mutate(
...
mod_total_team_svm = readRDS("mod_total_team_svm_2025_12_11.rds")
