...
week_n = ifelse(ceiling(as.integer(Sys.Date() - as.Date("2026-09-09")) / 7) + 1 > 22, 22, ceiling(as.integer(Sys.Date() - as.Date("2026-09-09")) / 7) + 1)
...
mod_total_team_svm = readRDS(str_c("data/mods/", "mod_total_team_svm_2026_07_02.rds"))
mod_total_playoffs_team_svm = readRDS(str_c("data/mods/","mod_playoffs_total_team_svm_2026_01_04.rds"))
mod_total_correct_enet = readRDS(str_c("data/mods/", "mod_total_correct_enet_2026_07_02.rds"))
mod_spread_correct_enet = readRDS(str_c("data/mods/", "mod_spread_correct_enet_2026_07_02.rds"))
...
df_pred_total_spread_fin %>% 
  ...
  mutate(
    ...
    points_text_label_position = 
      case_when(
        team_points_diff >= 0 ~ team_points_diff + 0.6,
        team_points_diff < 0 ~ team_points_diff - 0.6,
        .default = NA
      ),
