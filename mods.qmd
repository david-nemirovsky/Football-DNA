...
df_pred_total_spread_fin %>% 
  ...
  mutate(
    bet_total = 
      case_when(
        ind_total_current_hit == 1 & ind_total_hit == 1 & total_game_adj > total_line_current ~ str_c("Over ", total_line_current_label),
        ind_total_current_hit == 1 & ind_total_hit == 1 & total_game_adj < total_line_current ~ str_c("Under ", total_line_current_label),
        .default = "NA"
      ),
    bet_spread = 
      case_when(
